...
export const AuthProvider = ({ children }) => {
  ...
  const register = (email, password) => {
    ...
    location.href="/TE4_24-25_PokemonWeb/login" // Navigate to the login page after registration
  };
  ...
  const login = (email, password) => {
    ...
    if (user) {
      ...
      location.href="/TE4_24-25_PokemonWeb/" // Navigate to the homepage after successful login
    } else {
