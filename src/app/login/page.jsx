...
export default function LoginPage() {
  //Returns an object containing authentication-related functions and data. In this case, login function from the AuthContext, which will allow users to log in.
  const { login } = useAuth(); 
