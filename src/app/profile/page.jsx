...
export default function Profile() {
	const { logout, currentUser, isAuthenticated } = useAuth() //Retrieved from AuthContext, these provide access to the current user’s data and the logout function.
			...
			<div style={styles.profileBox}>
				...
				{currentUser && (
					<div style={{ ...styles.info, fontSize: `${fontSize}px` }}>
						...
						<p>
							You have <strong>{favouriteCount}</strong> favourite Pokémon.
						</p>
					</div>
				)}
